/**
 * Matching logic for home/room decor setup recommendations. Direct
 * adaptation of the original Diablo 4 build-matcher's proven approach:
 * contradiction resolution first, then scored matching within whatever
